...
class FrontEnd(object):
    ...
    def run(self):
        ...
        while not should_stop:
            ...
            ax_dt2 += self.tello.get_acceleration_x() * dt * dt

            ay_dt2 += self.tello.get_acceleration_y() * dt * dt
            ...
            up_down_velocity = 0
            for_back_velocity = vel_command_x
            left_right_velocity = vel_command_y
            yaw_velocity = 0

            print('vx_cmd: ', vel_command_x)
            print('vy_cmd: ', vel_command_y)
